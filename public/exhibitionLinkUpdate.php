...
function ciniki_artgallery_exhibitionLinkUpdate(&$ciniki) {
	...
	//
	$strsql = "UPDATE ciniki_artgallery_exhibition_links SET last_updated = UTC_TIMESTAMP()";
	...
	foreach($changelog_fields as $field) {
		if( isset($args[$field]) && $args[$field] != '' ) {
			...
			$rc = ciniki_core_dbAddModuleHistory($ciniki, 'ciniki.artgallery', 
				...
				2, 'ciniki_artgallery_exhibition_links', $args['exhibition_link_id'], $field, $args[$field]);
		}
	}
	...
	if( !isset($rc['num_affected_rows']) || $rc['num_affected_rows'] != 1 ) {
		ciniki_core_dbTransactionRollback($ciniki, 'ciniki.artgallery');
		return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1117', 'msg'=>'Unable to update exhibition link'));	
	}
	...
	$ciniki['syncqueue'][] = array('push'=>'ciniki.artgallery.exhibition_link', 
		'args'=>array('id'=>$args['exhibition_link_id']));
