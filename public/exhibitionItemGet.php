...
function ciniki_artgallery_exhibitionItemGet($ciniki) {
    ...
    $rc = ciniki_artgallery_checkAccess($ciniki, $args['tnid'], 'ciniki.artgallery.exhibitionItemGet'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    $modules = $rc['modules'];
    ...
    $strsql = "SELECT ciniki_artgallery_exhibition_items.id, "
        ...
        . "IF(ciniki_artgallery_exhibition_items.tenant_fee=0, '', ciniki_artgallery_exhibition_items.tenant_fee) AS tenant_fee, "
