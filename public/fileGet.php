...
function ciniki_artgallery_fileGet($ciniki) {
    ...
    $rc = ciniki_artgallery_checkAccess($ciniki, $args['tnid'], 'ciniki.artgallery.fileGet', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    if( !isset($rc['file']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.artgallery.33', 'msg'=>'Unable to find file'));
    }
