...
// Description
// -----------
// This method will update one or more settings for the artgallery module.
//
// Info
// ----
// Status: 			defined
...
// <rsp stat='ok' id='34' />
//
function ciniki_artgallery_settingsUpdate(&$ciniki) {
    //  
	...
	// Insert or update the entry in the ciniki_artgallery_settings table
	//
