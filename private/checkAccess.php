...
// Description
// ===========
// This function will check the user has access to the artgallery module and
...
// <rsp stat="ok" />
//
function ciniki_artgallery_checkAccess(&$ciniki, $business_id, $method) {
	//
	// Check if the business is active and the module is enabled
	//
	ciniki_core_loadMethod($ciniki, 'ciniki', 'businesses', 'private', 'checkModuleAccess');
	$rc = ciniki_businesses_checkModuleAccess($ciniki, $business_id, 'ciniki', 'artgallery');
	if( $rc['stat'] != 'ok' ) {
		return $rc;
	}
	$modules = $rc['modules'];
